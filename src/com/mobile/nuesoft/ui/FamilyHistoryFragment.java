...
public class FamilyHistoryFragment extends NuesoftFragment {
	...
	public View onFragmentCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		rootView = mInflater.inflate(R.layout.family_history_fragment_layout, container, false);
	...
	public void hideNoDataView(final View v) {
		...
		listView = (ListView) mInflater.inflate(R.layout.family_history_fragment_list_layout, null);
	...
	public class ListViewAdapter extends BaseAdapter {
		...
		private ArrayList<FamilyHistory> dataList;

		public ListViewAdapter(final PatientObj patient) {
			dataList = patient.getFAMILY_HISTORY();
			init();
		}
		...
		@Override
		public FamilyHistory getItem(int pos) {
		...
		public View getView(int pos, View convertView, ViewGroup container) {
			final FamilyHistory mFamilyHistoryItem = dataList.get(pos);
			...
			textView.setText(mFamilyHistoryItem.getDisplayName());
